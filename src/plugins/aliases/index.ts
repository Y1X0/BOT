...
const ALIASES: Alias[] = [
  ...
  { command: 'avatar', triggers: ['افتاري', 'افتار', 'صورتي', 'صورته', 'بروفايلي', 'بروفايل', 'البروفايل', 'صورة البروفايل'] },
  ...
  { command: 'premium', triggers: ['مميز', 'الاشتراك', 'اشتراك', 'بريميوم', 'الاشتراك المميز', 'ترقيه'] },
  { command: 'referral', triggers: ['احالتي', 'الاحاله', 'رابط الاحاله', 'رابطي', 'دعوه'] },
  { command: 'wallet', triggers: ['محفظتي', 'محفظه', 'المحفظه', 'نقاطي احاله'] },
  { command: 'buystars', triggers: ['شراء نجوم', 'اشتري نجوم', 'شحن نجوم', 'نجوم'] },
