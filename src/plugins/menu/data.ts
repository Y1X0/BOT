...
export const MENU: MenuCategory[] = [
  ...
  },
  {
    ...
    items: [
      ...
      { ar: 'حارس', cmd: 'guard', desc: 'تفعيل كل الحمايات دفعة واحدة' },
      { ar: 'رفع ادمن', cmd: 'promote', desc: 'ترقية عضو لمشرف (بالرد)' },
      { ar: 'تنزيل ادمن', cmd: 'demote', desc: 'تنزيل مشرف (بالرد)' },
      { ar: 'رفع ادمن بوت', cmd: 'radmin', desc: 'رتبة أدمن داخل البوت (بالرد)' },
      { ar: 'رفع مدير بوت', cmd: 'rmanager', desc: 'رتبة مدير داخل البوت (بالرد)' },
      { ar: 'رفع مالك بوت', cmd: 'rowner', desc: 'رتبة مالك داخل البوت (بالرد)' },
      { ar: 'رفع مميز', cmd: 'rvip', desc: 'رتبة عضو مميّز (بالرد)' },
      { ar: 'شيل رتبه', cmd: 'unrank', desc: 'سحب رتبة البوت (بالرد)' },
